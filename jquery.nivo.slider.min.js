...
/*
 * Minified on September 16, 2010 by Utkarsh Kukreti (http://github.com/utkarshkukreti/Nivo-Slider)
 */
...
if(settings.controlNav){var nivoControlWrapper=$('<div class="nivo-controlNavWrapper"></div>');var nivoControl=$('<div class="nivo-controlNav"></div>');nivoControlWrapper.append(nivoControl);slider.append(nivoControlWrapper);for(var i=0;i<kids.length;i++){if(settings.controlNavThumbs){var child=kids.eq(i);if(!child.is('img')){child=child.find('img:first');}
